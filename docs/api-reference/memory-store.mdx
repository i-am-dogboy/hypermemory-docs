...
The open-source server's `memory_store` tool accepts the same core fields plus `assets`, `relationships`, `source_uri`, and `force_extra_data`. It does not run background enrichment.
