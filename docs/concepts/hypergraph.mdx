...
The hosted service (SurrealDB-backed) stores data as:
...
The self-hosted open-source server stores all data in a single JSON file with the same logical structure.
