...
You can also use the [REST API](/api-reference/memory-load-link) instead of the MCP JSON-RPC format. REST endpoints accept standard JSON bodies with `Authorization: Bearer hm_YOUR_KEY` headers.
