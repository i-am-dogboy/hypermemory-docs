...
n8n's MCP node can connect directly to HyperMemory, giving your workflows access to all 11 memory tools.
...
All 11 `hm_*` tools are available through the MCP node. See [API Reference](/api-reference/overview) for parameters and response shapes.
